...
| [0018](./0018-execution-fields-on-agentrun-and-succeeded-condition.md) | Execution Fields on AgentRun, and a `Succeeded` Terminal Condition | proposed | in-sync | 2026-09-24 |
